const FooterComponent = function () {
  return /*html */`
  <footer class="bg-gray-100 mt-10 pb-10 clear-both">
  <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl pb-5 ">
      <div class="mt-10 grid grid-cols-5 gap-8 pt-4">
          <div class="">
              <h2 class=" text-xl font-bold">Liên Hệ</h2>
              <p>Hotline:1900-6035 <br>(1000 đ/phút, 8-21h kể cả T7, CN)</p>
          ...
          <div>
              <h2 class="text-xl font-bold">Về Tiki</h2>
              <p>Giới thiệu Tiki</p>
              <p>Tuyển dụng</p>
          ...
          <div>
              <h2 class="text-xl font-bold">Hợp tác và liên kết</h2>
