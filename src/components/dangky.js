...
const Dangky = ()=>{
    ...
    <div class="border w-[50%] rounded-md shadow-md flex justify-center items-center">
    ...
    <h1 class="text-2xl font-medium text-center pt-10">Đăng ký</h1><br>
        ...
        <a href="/dangnhap"><button type="button" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded w-96 ">Đăng ký</button></a>
        </div>
        <p class="text-center text-blue-500">Nếu có tài khoản click => <a class="text-red-600 hover:font-bold font-medium"
